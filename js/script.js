...
conts spans = document.querySelectorAll('h1 span')

spans.forEach(span => span.addEventListener('mosueover', function(e) {
...
for(i=0; i<categories.length; i++) {
    if(categories[i].hasAttribute('class')) {
        categories[1].classList.remove('showCategory')
        categories[1].classList.add('hideCategory')
